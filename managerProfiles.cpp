#include "managerProfiles.h"

ManagerProfile::ManagerProfile(const std::string& filename) {
    loadFontandPng();
...
void ManagerProfile::loadFontandPng() {
...
void ManagerProfile::setDisplay(sf::Text& text, const std::string& content, const sf::Font& font, int characterSize, const sf::Color& fillColor, float x, float y) {
...
void ManagerProfile::createDisplay() {
...
void ManagerProfile::updateDisplayedText() {
    ...
    setDisplay(followButtonText, "Click here", buttonfont, 20, sf::Color::Black, 1085, 345);
...
void ManagerProfile::following(const std::string& currentId, const std::string& othersId) {
    std::ifstream inFile("following.txt");
...
void ManagerProfile::follower(const std::string& othersId, const std::string& currentId) {
...
void ManagerProfile::handleMouseOver(sf::Text& button) {
    button.setFillColor(sf::Color::Red);
}

void ManagerProfile::handleMouseOut(sf::Text& button) {
    button.setFillColor(sf::Color::White);
}

void ManagerProfile::handleEvents() {
    sf::Event event;
